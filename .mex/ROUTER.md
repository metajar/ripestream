...
**Working:**
- Dokploy production deployment with authenticated runtime GeoLite2-ASN download from private Cloudflare R2, the embedded dashboard on port 3000, live ingestion, and persistent private ClickHouse/FalkorDB services
