...
**Working:**
- Dokploy production deployment with runtime GeoLite2-ASN download from Cloudflare object storage, the embedded dashboard on port 3000, live ingestion, and persistent private ClickHouse/FalkorDB services
